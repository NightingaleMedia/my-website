                ...
                <div class="container">
                    <div class="row pt--100 pb--80">
                        ...
                        <div class="col-lg-8 col-12">
                          ...
                          <iframe width="650" height="400" src="https://www.youtube.com/embed/_5hJkTuJksY" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe> </div>
                                <!-- End Portfolio Image -->

                                <!-- Start Portfolio Image -->
                                <div class="portfolio-image mb--50">
                                    <img src="../img/portfolio/flowers-2.png" alt="portfolio">
                                </div>
                                <!-- End Portfolio Image -->

                                <!-- Start Portfolio Image -->
                                <div class="portfolio-image">
                                    <img src="../img/portfolio/flowers-1.png" alt="portfolio">
                                </div>
                                <!-- End Portfolio Image -->
                        ...
                        <div class="col-lg-4 col-12 mt_md--40 mt_sm--40">
                            <div class="portfolio-left bk-portfolio-details">
                                <div class="portfolio-main-info">
                                    <h3 class="heading heading-h3 line-height-1-42">Sound Design - Timelapse</h3>
                                    <div class="portfolio-content mt--75 mb--75 mt_md--40 mb_md--40 mt_sm--40 mb_sm--40">
                                        ...
                                        <div class="desc mt--20">
                                            <p class="bk_pra">
                                            I saw this video while living in New York and noticed that there was no sound to it.  While it was already pressed and
                                            published, I decided to grab it and create my own sound design.  I had just gotten one of my first analog synths and I used this project
                                            as an excuse to try it out.
                                            <br><br>
                                            I am really happy with how this turned out.  My goal was to use completely electronic soundscapes and instruments
                                            that did not interfere with the overtly organic nature of the video.  Best listened to on headphones.
