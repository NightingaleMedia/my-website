  ...
  <?php include(SHARED_PATH . '/preloader.php');?>
    ...
    <?php include(SHARED_PATH . '/sidebar.php');?>
      ...
      <?php include(SHARED_PATH . '/popup-menu.php');?>
        <!-- Page Conttent -->
        <main class="page-content mt--100">
                    ...
                    <div class="row pt--100 pb--80">
                        ...
                        <div class="col-lg-8 col-12">
                            <div class="portfolio-right portfolio-details-gallery text-left">
                                ...
                                <iframe width="670" height="400" src="https://www.youtube.com/embed/sMG8K4bbyLs" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe></div>
                                <!-- End Portfolio Image -->

                                <!-- Start Portfolio Image -->
                                <div class="portfolio-image mb--50">
                                    <img src="../img/portfolio/starbucks-2.png" alt="portfolio">
                                </div>
                                <!-- End Portfolio Image -->

                                <!-- Start Portfolio Image -->
                                <div class="portfolio-image">
                                    <img src="../img/portfolio/starbucks-1.png" alt="portfolio">
                                </div>
                                <!-- End Portfolio Image -->
                        ...
                        <div class="col-lg-4 col-12 mt_md--40 mt_sm--40">
                            <div class="portfolio-left bk-portfolio-details">
                                <div class="portfolio-main-info">
                                    <h3 class="heading heading-h3 line-height-1-42">Starbucks "Give Good"</h3>
                                    <div class="portfolio-content mt--75 mb--75 mt_md--40 mb_md--40 mt_sm--40 mb_sm--40">
                                        ...
                                        <div class="desc mt--20">
                                            <p class="bk_pra">
                                            This track made it into the final 2 contenders for the Starbucks 2017 Holiday campaign.  As
                                            many know, the starbucks holiday cup choice has become an ad everyone expects.  Work on this
                                            started in October and I remember it well beause it was my first all nighter at the studio.
                                            <br>
                                            <br>
                                            I was a bit disappointed that this track didn't make it in but I couldn't be happier with
                                            how it turned out.  The creative director liked my original track but noticed that I used
                                            a lot of software instruments.  So most of the work went into re-recording the whole thing
                                    ...
                                    <div class="portfolio-details-list">
                                        ...
                                        <div class="details-list">
                                            <label>Client</label>
                                            <span>Starbucks</span>
                                            <span>Buck Animation</span>
                                        </div>

                                        <div class="details-list">
                                            <label>Agency</label>
                                              <span><a href="http://www.antfood.com/">Antfood</a></span>
                                        </div>

                                        <div class="details-list">
                                            <label>What I Did</label>
                                            <span>Composition, Sound Design</span>
                                        </div>
